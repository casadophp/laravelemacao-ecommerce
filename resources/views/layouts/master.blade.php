            ...
            <div class="section group">
                ...
                <div class="col_1_of_4 span_1_of_4">
                    ...
                    <div class="social-icons">
                        <h4>Follow Us</h4>
                        <ul>
                            <li><a href="#" target="_blank">{!! HTML::image('midia/images/facebook.png', 'Portal Pravaler') !!}</a></li>
                            <li><a href="#" target="_blank">{!! HTML::image('midia/images/twitter.png', 'Portal Pravaler') !!}</a></li>
                            <li><a href="#" target="_blank">{!! HTML::image('midia/images/skype.png', 'Portal Pravaler') !!}</a></li>
                            <li><a href="#" target="_blank">{!! HTML::image('midia/images/dribbble.png', 'Portal Pravaler') !!}</a></li>
                            <li><a href="#" target="_blank">{!! HTML::image('midia/images/linkedin.png', 'Portal Pravaler') !!}</a></li>
                            <div class="clear"></div>
                        </ul>
                    </div>
                </div>
